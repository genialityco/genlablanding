...
const personalizaciones = [
  {
    ...
    desc: "Colores corporativos, logos, tipografía, fondos animados de marca.",
  },
  {
    icon: Package,
    title: "Productos y catálogo real",
    desc: "Los premios, ítems o personajes son sus productos, no genéricos.",
  },
  {
    icon: MessageSquare,
    title: "Mensajes y tono de voz",
    desc: "Integrados naturalmente en pantallas, transiciones e instrucciones.",
  },
  {
    icon: Tag,
    title: "Premios y probabilidades",
    desc: "Usted define qué se gana y nosotros calibramos las probabilidades según su presupuesto.",
  },
  { icon: Volume2, title: "Música y sonido", desc: "Licencia de música acorde a su marca o composición original." },
  {
    ...
    desc: "Español, inglés, portugués. Modos accesibles para personas con discapacidad visual o motora.",
  },
];
...
const hitos = [
  ...
  },
  {
    ...
    icon: Palette,
    desc: "Adaptamos la mecánica del juego elegido a su universo de marca. Paleta, logos, productos, sonidos, premios, mensajes clave. Le enviamos previsualizaciones para aprobación.",
  },
  {
    num: "3",
  ...
  return (
    <div style={{ backgroundColor: "var(--gl-bg-light)", color: "var(--gl-text-on-light)" }}>
      <Section id="como" number="03" title="LA EXPERIENCIA">
        ...
        <p className="text-body" style={{ color: "var(--gl-gray-dark)", marginTop: "2rem", marginBottom: "3rem", maxWidth: "600px" }}>
        ...
        >
          <svg
            style={{ position: "absolute", top: "50px", left: "10%", width: "80%", height: "2px", zIndex: 0 }}
          ...
          <Step
            number="1"
            title="Conversamos su intención"
            text="Comprendemos qué quiere lograr: captar contactos, sorprender invitados, fortalecer su equipo, diferenciarse en un pasillo saturado, lanzar un producto con impacto. Cada intención abre un camino distinto en nuestro portafolio."
          />
          <Step
            number="2"
            title="Diseñamos a su medida"
            text="Adaptamos la experiencia elegida a su identidad: colores, logos, productos, premios, tono de voz. Le mostramos previsualizaciones antes de cualquier ejecución."
          />
          <Step
            number="3"
            title="Su equipo solo vive el evento"
            text="Nosotros nos encargamos del montaje, del soporte técnico, de operar en sitio y de entregarle el reporte. Su equipo se enfoca en lo importante: conectar con las personas que se acercan."
          />
        </div>
        ...
        <div style={{ marginBottom: "6rem" }}>
          ...
          <p className="text-body" style={{ color: "var(--gl-gray-dark)", marginBottom: "3rem", maxWidth: "640px" }}>
            Un juego Gen.Lab nunca se ve igual entre dos clientes. Lo personalizamos hasta los detalles que el visitante
            no nota — pero recuerda.
          </p>
  ...
  return (
    <div
      style={{
        ...
        position: "relative",
        zIndex: 1,
        backgroundColor: "var(--gl-bg-light)",
        padding: "1rem",
        textAlign: "center",
      }}
    >
      ...
      <p className="text-body-lg" style={{ fontWeight: "700", marginBottom: "0.5rem" }}>
        {title}
      </p>
      <p className="text-body" style={{ color: "var(--gl-gray-dark)" }}>
        {text}
      </p>
    </div>
  );
...
function HitoCard({ num, label, period, icon: Icon, desc }) {
  return (
    ...
    >
      ...
      <p className="text-small" style={{ color: "var(--gl-gray-dark)", lineHeight: "1.6" }}>
        {desc}
      </p>
    </div>
  );
